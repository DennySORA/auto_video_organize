...
use crate::tools::{
    DEFAULT_GRID_COLS, DEFAULT_GRID_ROWS, DEFAULT_THUMBNAIL_COUNT, VideoFileInfo,
    create_contact_sheet, create_thumbnail_tasks, detect_scenes, ensure_directory_exists,
    extract_thumbnails_parallel, get_video_info, scan_video_files, select_timestamps,
